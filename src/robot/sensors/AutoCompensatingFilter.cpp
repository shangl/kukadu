...
void AutoCompensatingFilter::printFilteredSensorVal(){
    ...
    std::vector<double> readings = {0.0,0.0};//getProcessedReading();
...
std::vector<double> AutoCompensatingFilter::projectReadings(std::vector<double> readings, geometry_msgs::Pose currentPose){ //memory problem?
