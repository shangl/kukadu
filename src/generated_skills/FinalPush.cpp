...
std::shared_ptr<kukadu::ControllerResult> FinalPush::executeInternal() {
		...
		std::dynamic_pointer_cast<kukadu::JointPtp>(skill2139)->setJoints({-0.9692263007164001, 1.113829493522644, 1.1473214626312256, -1.444376826286316, -0.28663957118988037, -0.8957559466362, -0.2651996612548828});
		...
		std::dynamic_pointer_cast<kukadu::JointPtp>(skill2140)->setJoints({-0.109378, 1.55693, 1.50002, -0.224965, -0.553483, -0.614582, -0.658589});
		...
		std::dynamic_pointer_cast<kukadu::JointPtp>(skill2141)->setJoints({-0.1002, 1.54825, 1.51948, -0.22662, -0.543338, -0.614317, -0.658062});
		...
		std::dynamic_pointer_cast<kukadu::JointPtp>(skill2142)->setJoints({-0.0793886, 1.54343, 1.5273, -0.222725, -0.54333, -0.607497, -0.669542});
		...
		std::dynamic_pointer_cast<kukadu::JointPtp>(skill2143)->setJoints({-0.0529747, 1.53886, 1.52831, -0.217783, -0.524916, -0.607438, -0.692989});
		...
		std::dynamic_pointer_cast<kukadu::JointPtp>(skill2144)->setJoints({-0.0422586, 1.53685, 1.52831, -0.21765, -0.515485, -0.606345, -0.705268});
		...
		std::dynamic_pointer_cast<kukadu::JointPtp>(skill2145)->setJoints({-0.0237716, 1.53687, 1.52831, -0.21757, -0.515368, -0.604097, -0.705288});
		...
		std::dynamic_pointer_cast<kukadu::JointPtp>(skill2146)->setJoints({-0.0156862, 1.53686, 1.52831, -0.217573, -0.515372, -0.59964, -0.708731});
		...
		std::dynamic_pointer_cast<kukadu::JointPtp>(skill2147)->setJoints({-0.0156172, 1.53727, 1.52831, -0.219744, -0.511537, -0.566932, -0.708706});
		...
		std::dynamic_pointer_cast<kukadu::JointPtp>(skill2148)->setJoints({-0.0390551, 1.53972, 1.52831, -0.262562, -0.576725, -0.567193, -0.683141});
		...
		std::dynamic_pointer_cast<kukadu::DMPExecutor>(skill2149)->setExecutionMode(kukadu::TrajectoryExecutor::EXECUTE_ROBOT);
		...
		std::dynamic_pointer_cast<kukadu::JointPtp>(skill2150)->setJoints({-0.9692263007164001, 1.113829493522644, 1.1473214626312256, -1.444376826286316, -0.28663957118988037, -0.8957559466362, -0.2651996612548828});
