...
namespace kukadu {
    ...
    class Gnuplot
    {
        ...
        /// \return file exists (yes == true, no == false)
        // ---------------------------------------------------------------------------------
          bool    file_exists(const std::string &filename, int mode=0);
        ...
        public:
            ...
            /// \return ---
            // ----------------------------------------------------------------------------
              void set_terminal_std(const std::string &type);
        ...
        // ----------------------------------------------------------------------
          Gnuplot& unset_smooth(){ smooth = ""; return *this;};
        ...
        /// turns grid on/off
          Gnuplot& set_grid()	{cmd("set grid");return *this;};
        /// grid is not set by default
          Gnuplot& unset_grid(){cmd("unset grid");return *this;};
        ...
        // -----------------------------------------------
          Gnuplot& set_multiplot(){cmd("set multiplot") ;return *this;};
        ...
        /// \return <-- reference to the gnuplot object
        // -----------------------------------------------
          Gnuplot& unset_multiplot(){cmd("unset multiplot");return *this;};
        ...
        /// \return <-- reference to the gnuplot object
        // ---------------------------------------------------------------------------
          Gnuplot& unset_hidden3d(){cmd("unset hidden3d"); return *this;};
        ...
        /// \return <-- reference to the gnuplot object
        // ------------------------------------------------------------------
          Gnuplot& unset_contour(){cmd("unset contour");return *this;};
        ...
        /// \return <-- reference to the gnuplot object
        // ------------------------------------------------------------------
          Gnuplot& set_surface(){cmd("set surface");return *this;};
        ...
        /// \return <-- reference to the gnuplot object
        // ------------------------------------------------------------------
          Gnuplot& unset_surface(){cmd("unset surface"); return *this;}
        ...
        /// \return <-- reference to the gnuplot object
        // ------------------------------------------------------------------
          Gnuplot& unset_legend(){cmd("unset key"); return *this;}
        ...
        /// \return <-- reference to the gnuplot object
        // ---------------------------------------------------------------------------------
          Gnuplot& unset_title(){this->set_title();return *this;}
        ...
        /// \return <-- reference to the gnuplot object
        // -----------------------------------------------
          Gnuplot& set_xautoscale(){cmd("set xrange restore");cmd("set autoscale x");return *this;};
        ...
        /// \return <-- reference to the gnuplot object
        // -----------------------------------------------
          Gnuplot& set_yautoscale(){cmd("set yrange restore");cmd("set autoscale y");return *this;};
        ...
        /// \return <-- reference to the gnuplot object
        // -----------------------------------------------
          Gnuplot& set_zautoscale(){cmd("set zrange restore");cmd("set autoscale z");return *this;};
        ...
        /// \return <-- reference to the gnuplot object
        // -----------------------------------------------
          Gnuplot& unset_xlogscale(){cmd("unset logscale x"); return *this;};
        ...
        /// \return <-- reference to the gnuplot object
        // -----------------------------------------------
          Gnuplot& unset_ylogscale(){cmd("unset logscale y"); return *this;};
        ...
        /// \return <-- reference to the gnuplot object
        // -----------------------------------------------
          Gnuplot& unset_zlogscale(){cmd("unset logscale z"); return *this;};
        ...
        /// \return ---
        //----------------------------------------------------------------------------------
          Gnuplot& replot(void){if (nplots > 0) cmd("replot");return *this;};
