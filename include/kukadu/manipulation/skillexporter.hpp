...
namespace kukadu {
    ...
    public:
        ...
        void exportSkillExecutions(int skillId, long long int startTime, long long int endTime, std::vector<KUKADU_SHARED_PTR<kukadu::Hardware> > hardwareInstances, std::string folder);
