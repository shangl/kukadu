...
enum POSE_ESTIMATOR {
	POSE_ESTIMATOR_ORIGINAL = 1,			// original "normal" pose estimator
	POSE_ESTIMATOR_ORIGINAL_CONT = 2,		// original "cont" pose estimator
	POSE_ESTIMATOR_RPP = 3					// new "Robust Planar Pose" estimator
};
...
ARTOOLKITPLUS_API kukadu::TrackerSingleMarker* createTrackerSingleMarker(int nWidth, int nHeight,
																				int nMarkerSizeX, int nMarkerSizeY, int nMarkerSampleNum,
                                                                                kukadu::PIXEL_FORMAT nPixelFormat = kukadu::PIXEL_FORMAT_RGB);
