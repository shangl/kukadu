...
#include <kukadu/vision/arlocalizer/TrackerSingleMarker.h>
#include <kukadu/vision/arlocalizer/TrackerImpl.h>
#include <kukadu/vision/arlocalizer/Logger.h>
#include <kukadu/vision/arlocalizer/config.h>
...
public:
	 ...
	 */
    virtual bool init(const char* nCamParamFile, ARFloat nNearClip, ARFloat nFarClip, Logger* nLogger=NULL);
    virtual bool init(Camera* camera, ARFloat nNearClip, ARFloat nFarClip, Logger* nLogger=NULL);
	...
	*/
    ...
    void setLogger(Logger* nLogger)  {  AR_TEMPL_TRACKER::setLogger(nLogger);  }
...
#include <kukadu/vision/arlocalizer/TrackerSingleMarkerImpl.cxx>
