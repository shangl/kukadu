...
#include <kukadu/vision/arlocalizer/arBitFieldPattern.h>
...
static void
checkPatternBCH(IDPATTERN nPattern, int& nID, float& nProp, kukadu::BCH* nProcessor)
{
	int err = -1;
    kukadu::_64bits decodedPattern = 0;
