...
/**
 *  kukadu::TrackerSingleMarker provides all methods to access ARToolKit for
...
public:
	 ...
	 */
    virtual bool init(const char* nCamParamFile, ARFloat nNearClip, ARFloat nFarClip, kukadu::Logger* nLogger=NULL) = 0;
    virtual bool init(Camera* camera, ARFloat nNearClip, ARFloat nFarClip, kukadu::Logger* nLogger=NULL) = 0;
