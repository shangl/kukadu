...
\item The kinematics module (\hyperlink{kinematicspage}{The kinematics module})\+: As the name already says, the kinematics module provides kinematics for a given robot. It includes interfaces and implementations for forward and inverse kinematics as well as path planning functionality. The only prerequisite is an appropriate robot model in U\+R\+DF format. Currently, interfaces to Move\+It and K\+O\+MO are available.
...
\item S\+VM
\item Control policy reinforcement learning (Po\+W\+ER)
\item Reinforcement learning (Projective simulation, Monte carlo RL, Q-\/\+Learning, S\+A\+R\+SA)
\end{DoxyItemize}
\end{DoxyItemize}
