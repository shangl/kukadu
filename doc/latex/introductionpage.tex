...
kukadu is written in C++ and supports usage in combination with \href{http://www.ros.org/}{\tt R\+OS}. It provides several general interfaces and implements it with state of the art methods from control, machine learning and robotic manipulation.

This document provides a setup guide (\hyperlink{installationpage}{Installation}) including a recommendation on how to develop kukadu software using \href{https://www.qt.io/ide/}{\tt Qt\+Creator}. Further, several tutorials and an A\+PI documentation is given.
