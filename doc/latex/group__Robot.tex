...
class \hyperlink{classRosSchunk}{Ros\+Schunk}
\begin{DoxyCompactList}\small\item\em Provides control capabilities for the Schunk S\+DH robotic hand with R\+OS binding Implements the Generic\+Hand interface for the Schunk S\+DH robotic hand. Note that using this class the programm has to be executed with root rights. \end{DoxyCompactList}\item 
